...
namespace VIAT.WorkFlow.Services
{
    public partial class Viat_wk_cont_stretagy_detail_selectService
    {
        ...
        public override WebResponseContent DownLoadTemplate()
        {
            ...
            DownLoadTemplateColumns = x => new { x.stretagy_id,x.stretagy_name,x.amount, x.prod_id,x.prod_ename,x.nhi_price,x.invoice_price,x.net_price,x.min_qty,x.isbelong };
