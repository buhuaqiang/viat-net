 ...
 *Repository提供数据库操作，如果要增加数据库操作请在当前目录下Partial文件夹Viat_wk_bid_detailRepository编写代码
 */
...
namespace VIAT.WorkFlow.Repositories
{
    ...
    public static IViat_wk_bid_detailRepository Instance
    {
      get {  return AutofacContainerModule.GetService<IViat_wk_bid_detailRepository>(); } }
    }
}
