...
{
    [Entity(TableCnName = "合約產品List", TableName = "Viat_app_power_contract_purchase_prod")]
    public partial class Viat_app_power_contract_purchase_prod_select : BaseEntity
    {
      /*  /// <summary>
        ///識別碼, PK, Identity
        /// </summary>
...
*/
        ...
        [Column(TypeName = "uniqueidentifier")]
        [Required(AllowEmptyStrings = false)]
        public Guid powercontpurprod_dbid { get; set; }
