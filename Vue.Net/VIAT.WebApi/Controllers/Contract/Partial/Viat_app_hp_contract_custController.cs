...
{
    public partial class Viat_app_hp_contract_custController
    {
        private readonly IViat_app_hp_contract_custService _service;//访问业务代码
        private readonly IHttpContextAccessor _httpContextAccessor;

        [ActivatorUtilitiesConstructor]
        public Viat_app_hp_contract_custController(
            IViat_app_hp_contract_custService service,
