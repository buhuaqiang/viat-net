...
namespace VIAT.System.Services
{
    public partial class Sys_UserService
    {
        ...
        public List<Viat_Sys_Org_Level_Detail> GetLevelDetail(string emp_dbid)
        {
            ...
            List<Viat_Sys_Org_Level_Detail> detailList = repository.DapperContext.QueryList<Viat_Sys_Org_Level_Detail>(sql, null);
