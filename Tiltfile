SOURCE_IMAGE = os.getenv("SOURCE_IMAGE", default='your-registry.io/project/viatris-webapi-source') # update registry
...
k8s_resource(NAME, port_forwards=["8080:8080"],
            extra_pod_selectors=[{'carto.run/workload-name': 'viatris-webapi', 'app.kubernetes.io/component': 'run'}])
