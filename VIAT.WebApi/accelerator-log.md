...
```json
{
  "applicationName" : "viatris-webapi-app",
  "projectName" : "viatris-webapi"
}
```
## Log
```
...
┃ ┃ ┃ Debug Adding symbol compilerSafeAppName with value 'viatris_webapi_app'
...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->viatris-webapi-app]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'viatris-webapi-app.csproj'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [sample-app->viatris-webapi]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->viatris_webapi_app]
